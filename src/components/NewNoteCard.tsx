        ...
        <Dialog.Content className='fixed overflow-hidden left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 max-w-[640px] w-full h-[60vh] bg-slate-700 rounded-md flex flex-col outline-none'>
          ...
          <div className='flex flex-1 flex-col gap3 p-5'>
            ...
            <p className='text-sm leading-6 text-slate-300'>
              Start <button className='font-medium text-lime-400 hover:underline'>recording an audio</button> or <button className='font-medium text-lime-400 hover:underline'>write some note</button>.
            </p>
          </div>
